...
public class ResumenGastosAdapter extends ArrayAdapter<ResumenGastoDataModel> implements View.OnClickListener {
    ...
    ResumenGastosAdapter(ArrayList<ResumenGastoDataModel> data, Context context) {
    ...
    public void onClick(View v) {
        ...
        ResumenGastoDataModel object = getItem(position);
        ResumenGastoDataModel dataModel = object;
    }
